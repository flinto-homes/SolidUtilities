namespace SolidUtilities.Editor.Helpers
{
    ...
    public static class EditorIcons
    {
        ...
        public static readonly EditorIcon TriangleRight = new EditorIcon(Database.TriangleRight != null ? Database.TriangleRight : (Texture2D) EditorGUIUtility.Load("Animation.Play"));
